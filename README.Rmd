...
The avaialble expressions are dependent on the type of data in the field. In
...
comma seperated list of choices to include or exclude (`gon=10,20` or
...
detailed information can be found in the technical documentation for the fn_portal API.
