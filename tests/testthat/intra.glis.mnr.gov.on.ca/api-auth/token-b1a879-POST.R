structure(list(
  ...
  status_code = 400L, headers = structure(list(
    ...
    allow = "POST, OPTIONS", `djdt-store-id` = "c6de598c0dba45059c21eebe8d729ba0",
  ...
  date = structure(1701893281, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 0.000147,
    connect = 0.000539, pretransfer = 0.001029, starttransfer = 0.001034,
    total = 0.310427
  )
), class = "response")
