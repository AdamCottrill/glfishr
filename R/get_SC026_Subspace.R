...
#'
#' See
#' http://10.167.37.157/creels/api/v1/redoc/#operation/sc026subspace_list
...
#'
#' sc026_subspace <- get_SC026_Subspace(list(prj_cd = "LHA_IA19_812"))
#' sc026_subspace <- get_SC026_Subspace(list(prj_cd = "LHA_IA19_812"), show_id = TRUE)
