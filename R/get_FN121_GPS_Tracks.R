...
#' protocol, etc.
#'
#' Use \code{show_filters("fn121_gps_tracks")} to see the full list of
...
get_FN121_GPS_Tracks <- function(filter_list = list(), show_id = FALSE, to_upper = TRUE, record_count = FALSE, add_year_col = FALSE) {
